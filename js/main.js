...
function initializeApp() {
    ...
    if (!cfg.canvas || !cfg.ctx || !cfg.statusDiv || !cfg.settingsPanel || !cfg.controlsDiv || !cfg.instructionsDiv || !cfg.canvasContainer || !cfg.infoPanel || !cfg.instrTopContainer || !cfg.canvasTopContainer || !cfg.infoTopContainer || !cfg.flagEditorModalContainer || !mapEditorView || !fullFlagEditorView || !navMapEditorTab || !navFlagEditorTab) { // Added checks
        console.error("Essential static DOM elements not found! Aborting initialization. Check HTML structure and IDs.", {
             ...
             flagEditorModalContainer: !!cfg.flagEditorModalContainer, mapEditorView: !!mapEditorView, fullFlagEditorView: !!fullFlagEditorView,
             navMapEditorTab: !!navMapEditorTab, navFlagEditorTab: !!navFlagEditorTab
         });
    ...
    if (!cfg.loadMapLabel || !cfg.saveButton || !cfg.markerSizeInput || !cfg.editFlagButton) {
