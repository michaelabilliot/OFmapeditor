...
export let imageInput,
  ...
  jsonLoadLabel,
  saveButton,
  loadFlagsButton; // zoomInButton, zoomOutButton, zoomResetButton, zoomDisplay removed
export let statusDiv,
  coordinateDisplay,
  nationListContainer,
  nationListUl,
  nationListCountSpan,
  settingsButton,
  settingsPanel;
export let closeSettingsButton,
  markerSizeInput,
  markerSizeValue,
  darkModeToggle,
  nationTextSizeInput,
  ...
  flagSizeInput,
  flagSizeValue;
export let inlineEditPanel,
  inlineEditName,
  inlineEditStrength,
  inlineEditSave,
  inlineEditCancel;
export let infoNameSpan, infoStrengthSpan, infoPlaceholder;
export let infoFlagPreview,
  infoFlagStatus,
  infoFlagUploadInput,
  infoFlagUploadLabel,
  infoFlagRemoveButton;
...
export function assignElements() {
  ...
  flagEditorModalContainer = document.getElementById(
...
export function setMarkerRadius(value) {
  _markerRadius = value;
}
export function setNationTextSize(value) {
  _nationTextSize = value;
}
export function setFlagBaseDisplaySize(value) {
  _flagBaseDisplaySize = value;
}
export function setNations(newNations) {
  nations = newNations;
}
export function setOriginalMapImage(newOriginalMapImage) {
  originalMapImage = newOriginalMapImage;
}
export function setMapImage(newMapImage) {
  mapImage = newMapImage;
}
export function setMapInfo(newMapInfo) {
  mapInfo = newMapInfo;
}
export function setSelectedNationIndex(index) {
  selectedNationIndex = index;
}
export function setHoveredNationIndex(index) {
  hoveredNationIndex = index;
}
export function setHoveredListIndex(index) {
  hoveredListIndex = index;
}
export function setNationIndexBeingEdited(index) {
  nationIndexBeingEdited = index;
}
export function setZoom(newZoom) {
  zoom = newZoom;
}
export function setOffsetX(newOffsetX) {
  offsetX = newOffsetX;
}
export function setOffsetY(newOffsetY) {
  offsetY = newOffsetY;
}
export function setIsPanning(state) {
  isPanning = state;
}
export function setDraggingNation(state) {
  draggingNation = state;
}
export function setPotentialPan(state) {
  potentialPan = state;
}
export function setMouseDownPos(pos) {
  mouseDownPos = pos;
}
export function setPanStartOffset(offset) {
  panStartOffset = offset;
}
export function setDragNationOffset(offset) {
  dragNationOffset = offset;
}
export function setCurrentModalResolve(resolveFn) {
  currentModalResolve = resolveFn;
}
export function setIsPanningAnimationActive(state) {
  isPanningAnimationActive = state;
}
export function setIsSettingsVisible(state) {
